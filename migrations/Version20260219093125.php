 ...
 */
final class Version20260219093125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dish CHANGE is_active is_active TINYINT DEFAULT 1 NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dish CHANGE is_active is_active TINYINT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
